...
@Component({
  selector: 'app-weather-forecast-three-hour-step',
  standalone: true,
  imports: [
    SpinnerComponent,
    NgIf,
  ...
  templateUrl: './weather-forecast-three-hour-step.component.html',
  styleUrl: './weather-forecast-three-hour-step.component.scss',
})
export class WeatherForecastThreeHourStepComponent
